...
//   final String url;
//   const WebViewCarter({Key? key, required this.url}) : super(key: key);
...
//       final endpoint = value!.replaceAll(r'https://www.carters.com', '');
...
//             child: InkWell(
//               onTap: () async {
//                 showLoaderDialog(context, "Getting shiping info");
//                 await getPrice(vm);
//               },
//               child: Container(
//                 child: Center(
