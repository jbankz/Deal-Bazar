...
// class WebViewNike extends StatefulWidget {
//   final String url;
//   const WebViewNike({Key? key, required this.url}) : super(key: key);

//   @override
//   State<WebViewNike> createState() => _WebViewNikeState();
// }

// class _WebViewNikeState extends State<WebViewNike> {
//   double price = 0;
//   String? initialUrl;
//   getPrice(vm) async {
//     _controller!.currentUrl().then((value) async {
//       final endpoint = value!.replaceAll(r'https://www.nike.com', '');
